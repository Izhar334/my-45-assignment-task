...
let favoriteVehicles = ["Honda CD70", "Suzuki 150 Bike", "Kia Sportage Car"];
...
let guestList = ["Mian Arman Arain", "Mr Yaqoob Malik", "Mr Faizan Malik"];
...
let guestList1 = ["Mian Arman Arain", "Mr Yaqoob Malik", "Mr Faizan Malik"];
...
let guestList2 = ["Mr Adil Khan", "Mr Rehaan Khan"];
let guestWhoCantMakeIt1 = "Mr Faizan Malik";
// Find the index of the guest who can't make it (using indexOf)
let indexOfGuestWhoCantMakeIt1 = guestList2.indexOf(guestWhoCantMakeIt1);
...
let newGuests = ["Mr Adil Khan", "Mian Arman Malik", "Usama Khan", "Mr Yaqoob Malik", "Mr Rehaan Khan",];
...
// Array of mountains
const mountains = ["Mount Everest", "K2", "Kilimanjaro"];
const rivers = ["Indus 2900", "Jehlum 725"];
// Array of countries
const countries = ["Pakistan", "Dubai", "Qater"];
// Array of cities
const cities = ["Karachi", "Faisal Abad", "Lahore"];
// Array of languages
const languages = ["English", "Urdu", "Panjabi"];
...
let alien_color1 = "green"; // Change to a non-green color ("yellow" or "red") for else block
...
let alien_color2 = "green"; // Change to "yellow" or "red" for different outcomes
...
let furryFriends = ["dog", "cat", "rabbit"];
...
const magicians = ["David Copperfield", "Criss Angel", "Dynamo"];
...
const magicians2 = ["David Copperfield", "Criss Angel", "Dynamo"];
...
function buildSandwichSummary(...sandwichItems) {
...
const myCar = createCar("Tesla", "Model S");
